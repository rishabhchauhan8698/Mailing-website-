...
?></div>
	 ...
	 <div style="float:left;margin-left:300px;padding-top:40px;font-size:25px;text-align:center;color:black"> Welcome <?php  echo @$_SESSION['sid'];?>
	 </div>
 	  </td>
  </tr>
  <tr>
    <td height="38" colspan="3">
		...
		<a style="margin-left:50px" href="HomePage.php?chk=vprofile">YOUR PROFILE</a>
